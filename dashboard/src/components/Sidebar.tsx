...
import { LayoutDashboard, MessageSquare, Users, LogOut, Hexagon, X, Network, Zap, Wallet, Fingerprint, Coins, Terminal, Swords, Brain, Gem, Eye, DollarSign, BarChart3, ArrowLeftRight, Archive, GitBranch, Database } from "lucide-react";
import { cn } from "@/lib/utils";

const NAV_ITEMS = [
  { href: "/", label: "Command Center", icon: LayoutDashboard, shortcut: "01", key: "1" },
  { href: "/memory", label: "Memory System", icon: Database, shortcut: "02", key: "2" },
  { href: "/palace", label: "Palace", icon: Archive, shortcut: "03", key: "3" },
  { href: "/knowledge", label: "Knowledge Graph", icon: GitBranch, shortcut: "04", key: "4" },
  { href: "/agent", label: "Agent Chat", icon: MessageSquare, shortcut: "05", key: "5" },
  { href: "/swarms", label: "Swarms", icon: Network, shortcut: "06", key: "6" },
  { href: "/fleet", label: "Fleet", icon: Users, shortcut: "07", key: "7" },
  { href: "/intent", label: "Intent", icon: Zap, shortcut: "08", key: "8" },
  { href: "/consciousness", label: "Consciousness", icon: Brain, shortcut: "09", key: "9" },
  { href: "/payments", label: "Payments", icon: Wallet, shortcut: "10", key: "0" },
  { href: "/identity", label: "Identity", icon: Fingerprint, shortcut: "11" },
  { href: "/oracle", label: "Oracle", icon: Eye, shortcut: "12" },
  { href: "/token", label: "$AKUAHIVE", icon: Coins, shortcut: "13" },
  { href: "/logs", label: "Logs", icon: Terminal, shortcut: "14" },
  { href: "/arena", label: "Arena", icon: Swords, shortcut: "15" },
  { href: "/memory-cosmos", label: "Memory Cosmos", icon: Gem, shortcut: "16" },
  { href: "/midas", label: "Midas Revenue", icon: DollarSign, shortcut: "17" },
  { href: "/report", label: "Intelligence", icon: BarChart3, shortcut: "18" },
  { href: "/trading", label: "Trading / DeFi", icon: ArrowLeftRight, shortcut: "19" },
];
